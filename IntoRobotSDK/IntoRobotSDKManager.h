...
#import "IntoRobotAPIManager.h"
#import "IntoRobotIMLinkManager.h"

// appID
UIKIT_EXTERN NSString *_ml_appID;
// appKey
UIKIT_EXTERN NSString *_ml_appKey;

@interface IntoRobotSDKManager : NSObject
/** 设置是否打印Log */
+ (void)setLogEnable:(BOOL)Value;

/** 设置app的应用ID，此APPID从开发平台获取 */
